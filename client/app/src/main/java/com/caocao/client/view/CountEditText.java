...
public class CountEditText extends RelativeLayout {
    ...
    public CountEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.layout_edittext_count, this, true);
        ...
        if (typedArray != null) {
            //默认文字
            text = typedArray.getString(R.styleable.CountEditText_etText);
            ...
            //横线颜色
            LineColor = typedArray.getColor(R.styleable.CountEditText_etLineColor, Color.BLACK);
